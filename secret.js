...
//des加密
exports.des_encrypt = function(plantext,key,iv){
...
//des解密
exports.des_decrypt = function(encrypt_text,key,iv){
    var algorithm ={ ecb:'des-ecb',cbc:'des-cbc',ede3:'des-ede3-cbc'};
    key = new Buffer(key,'base64');
    iv = new Buffer(iv ? iv : 0);
...
exports.random_b64 = function(){
    var a = crypto.randomBytes(256);
    return a.toString('base64');
}

exports.md5_32 = function(content){
    if(typeof content == 'string'){
        return content.MD5(32);
    }
}

exports.md5_16 = function(content){
    if(typeof content == 'string'){
        return content.MD5();
    }
}